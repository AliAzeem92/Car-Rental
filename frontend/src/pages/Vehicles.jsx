...
const Vehicles = () => {
  ...
  const [formData, setFormData] = useState({
    brand: '', model: '', year: '2026', licensePlate: '', category: '',
    color: '', seats: '', transmission: 'Manual', fuelType: 'Petrol', status: 'AVAILABLE',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast(error.response?.data?.error || 'Failed to create vehicle', 'error');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      if (editModal.transmission) formDataObj.append('transmission', editModal.transmission);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              <th className="px-6 py-4 text-center text-sm font-semibold text-gray-600 w-[10%]">PHOTO</th>
              <th className="px-6 py-4 text-center text-sm font-semibold text-gray-600 w-[15%]">VEHICLE</th>
              <th className="px-6 py-4 text-center text-sm font-semibold text-gray-600 w-[12%]">PLATE</th>
              <th className="px-6 py-4 text-center text-sm font-semibold text-gray-600 w-[13%]">CATEGORY</th>
              <th className="px-6 py-4 text-center text-sm font-semibold text-gray-600 w-[12%]">DAILY PRICE</th>
              <th className="px-6 py-4 text-center text-sm font-semibold text-gray-600 w-[12%]">MILEAGE</th>
              <th className="px-6 py-4 text-center text-sm font-semibold text-gray-600 w-[13%]">STATUS</th>
              <th className="px-6 py-4 text-center text-sm font-semibold text-gray-600 w-[13%]">ACTIONS</th>
            </tr>
          </thead>
          <tbody className={`divide-y divide-gray-100 transition-opacity duration-150 ${
            ...
            {paginatedVehicles.map(vehicle => (
              <tr key={vehicle.id} className="hover:bg-gray-50 transition">
                ...
                <td className="px-6 py-4">
                  <div className="text-xs font-semibold text-gray-800">{vehicle.brand} {vehicle.model}</div>
                  <div className="text-xs text-gray-500">2026 • #{vehicle.id}</div>
                </td>
                <td className="px-6 py-4">
      ...
      <div className="flex justify-between items-center text-sm text-gray-600">
        <span>Showing {((currentPage - 1) * itemsPerPage) + 1}-{Math.min(currentPage * itemsPerPage, vehicles.length)} of {vehicles.length}</span>
        <div className="flex items-center gap-2">
          <button 
      ...
      <Modal isOpen={showModal} onClose={() => { setShowModal(false); resetForm(); }} title="Add New Vehicle" size="max-w-6xl">
        <form onSubmit={handleSubmit} className="max-h-[75vh] overflow-y-auto pr-2">
          <div className="space-y-5">
            ...
            <div className="border-t pt-4">
              <h3 className="text-base font-semibold text-gray-800 mb-3">Pricing & Mileage</h3>
            ...
            <div className="border-t pt-6">
              <h3 className="text-base font-semibold text-gray-800 mb-4">Photos ({images.length}/4)</h3>
              <div className="flex gap-3 flex-wrap">
                {images.map((img, idx) => (
                  <div key={idx} className="relative w-32 h-32 rounded-lg overflow-hidden border-2 border-gray-300">
          ...
          <div className="mt-6 flex gap-4">
            ...
            <Button type="button" onClick={() => { setShowModal(false); resetForm(); }} variant="secondary" className="flex-1">
              Cancel
            </Button>
          </div>
        </form>
      ...
      <Modal isOpen={!!editModal} onClose={() => { setEditModal(null); resetForm(); }} title="Edit Vehicle" size="max-w-6xl">
        {editModal && (
          <form onSubmit={handleUpdate} className="max-h-[75vh] overflow-y-auto pr-2">
            <div className="space-y-5">
              <div>
                <h3 className="text-base font-semibold text-gray-800 mb-3">Basic Information</h3>
                <div className="grid grid-cols-5 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditModal({ ...editModal, licensePlate: e.target.value })}
                      className="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditModal({ ...editModal, seats: e.target.value })}
                      className="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <Dropdown
                      ...
                      onChange={(value) => setEditModal({ ...editModal, transmission: value })}
                      options={transmissionOptions}
                      showColor={true}
                      width="w-full"
                    />
                  ...
                  <div>
                    ...
                    <Dropdown
                      ...
                      onChange={(value) => setEditModal({ ...editModal, fuelType: value })}
                      options={fuelTypeOptions}
                      showColor={true}
                      width="w-full"
                    />
                  ...
                  <div>
                    ...
                    <Dropdown
                      ...
                      onChange={(value) => setEditModal({ ...editModal, status: value })}
                      options={statusOptions}
                      showColor={true}
                      width="w-full"
                    />
                ...
                <div className="mt-3">
                  ...
                  <input
                    ...
                    onChange={(e) => setEditModal({ ...editModal, features: e.target.value })}
                    className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditModal({ ...editModal, dailyPrice: e.target.value })}
                      className="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditModal({ ...editModal, deposit: e.target.value })}
                      className="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
              ...
              <div className="border-t pt-6">
                <h3 className="text-base font-semibold text-gray-800 mb-4">Photos ({existingImages.length + images.length}/4)</h3>
                <div className="flex gap-3 flex-wrap">
                  {existingImages.map((img) => (
                    <div key={img.id} className="relative w-32 h-32 rounded-lg overflow-hidden border-2 border-gray-300">
                  ...
                  {images.map((img, idx) => (
                    <div key={`new-${idx}`} className="relative w-32 h-32 rounded-lg overflow-hidden border-2 border-gray-300">
                      <img src={URL.createObjectURL(img)} alt="Preview" className="w-full h-full object-cover" />
                      <button
                        type="button"
                        onClick={() => setImages(images.filter((_, i) => i !== idx))}
            ...
            <div className="mt-6 flex gap-4">
              ...
              <Button type="button" onClick={() => { setEditModal(null); resetForm(); }} variant="secondary" className="flex-1">
                Cancel
              </Button>
            </div>
          </form>
