    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-600 p-4">
      <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-2xl w-full max-w-md border border-white/20">
        ...
        <div className="mt-8 p-4 bg-gray-50 rounded-xl border border-gray-200">
          <p className="text-xs text-gray-600 text-center mb-2 font-medium">{t('login.demoCredentials')}</p>
          <div className="text-xs text-gray-500 space-y-1">
            <p><span className="font-medium">{t('login.admin')}:</span> admin@carrental.com / admin123</p>
            <p><span className="font-medium">{t('navbar.customer')}:</span> john.doe@example.com / admin123</p>
          </div>
        </div>
      </div>
    </div>
